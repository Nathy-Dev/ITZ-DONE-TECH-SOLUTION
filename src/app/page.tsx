          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <h2 className="text-4xl md:text-5xl font-bold leading-tight">
                Why thousands of students choose <span className="text-indigo-600">ITZ-DONE</span> every day.
              </h2>
              ...
              <div className="pt-4">
                <Link href="/register" className="px-10 py-4 bg-indigo-600 text-white font-bold rounded-2xl hover:bg-indigo-700 shadow-xl shadow-indigo-600/20 transition-all active:scale-95 inline-block">
                  Join the Community
                </Link>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center space-y-2 group">
              <h3 className="text-4xl font-extrabold text-indigo-600 group-hover:scale-110 transition-transform">500+</h3>
              <p className="text-sm text-muted-foreground font-medium uppercase tracking-wider">Expert Courses</p>
            </div>
            <div className="text-center space-y-2 group">
              <h3 className="text-4xl font-extrabold text-indigo-600 group-hover:scale-110 transition-transform">250k+</h3>
              <p className="text-sm text-muted-foreground font-medium uppercase tracking-wider">Active Students</p>
            </div>
            <div className="text-center space-y-2 group">
              <h3 className="text-4xl font-extrabold text-indigo-600 group-hover:scale-110 transition-transform">120+</h3>
              <p className="text-sm text-muted-foreground font-medium uppercase tracking-wider">Elite Mentors</p>
            </div>
            <div className="text-center space-y-2 group">
              <h3 className="text-4xl font-extrabold text-indigo-600 group-hover:scale-110 transition-transform">98%</h3>
          ...
          <div className="relative rounded-[3rem] bg-indigo-600 overflow-hidden shadow-2xl shadow-indigo-600/20">
            ...
            <div className="relative px-8 py-16 md:p-20 flex flex-col items-center text-center space-y-8 z-10">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white max-w-2xl leading-tight">
                ...
                <span className="text-indigo-200">Become an Instructor.</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-6 pt-4">
                <Link 
                  href="/teach" 
                  className="px-10 py-5 bg-white text-indigo-600 font-bold rounded-2xl hover:bg-slate-50 transition-all shadow-xl shadow-black/10 flex items-center justify-center gap-2 group"
                >
                ...
                <Link 
                  href="/learn-more" 
                  className="px-10 py-5 bg-indigo-700/50 backdrop-blur-md text-white font-bold rounded-2xl border border-indigo-400/30 hover:bg-indigo-700 transition-all flex items-center justify-center gap-2"
                >
                  Watch How it Works
