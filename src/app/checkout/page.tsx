  ...
  return (
    <div className="min-h-screen pt-20 pb-10 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link
          href="/cart"
          className="flex items-center gap-2 text-sm font-bold text-muted-foreground hover:text-blue-600 transition-colors mb-8 group w-fit"
        >
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-4xl font-semibold mb-4">Finalize Checkout</h1>
            ...
            <div className="space-y-6">
              <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm relative group overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-blue-600/10 rounded-full -mr-16 -mt-16 blur-3xl group-hover:scale-150 transition-transform duration-700" />

                <div className="flex items-center gap-4 mb-8">
                  <div className="w-12 h-12 bg-blue-600 text-white rounded-2xl flex items-center justify-center shadow-sm shadow-blue-600/20">
              ...
              <div className="bg-blue-600 text-white p-8 rounded-2xl shadow-sm shadow-blue-600/20 relative overflow-hidden group">
                <div className="absolute bottom-0 left-0 w-32 h-32 bg-white/10 rounded-full -ml-16 -mb-8 blur-3xl group-hover:scale-150 transition-transform duration-700" />
                <div className="relative z-10 flex items-start gap-4">
                  <ShieldCheck className="w-8 h-8 text-blue-600 shrink-0" />
                  <div className="space-y-4">
                    <h3 className="font-semibold text-xl leading-tight">100% Satisfaction Guarantee</h3>
            ...
            <div className="flex items-center gap-3 p-4 bg-amber-500/10 border border-amber-500/20 rounded-2xl text-amber-700">
          ...
          <div className="lg:block">
            <div className="sticky top-32 bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
              ...
              <div className="p-8 pt-0 space-y-8 bg-gradient-to-t from-slate-50/50 to-transparent">
                ...
                <div className="space-y-4 font-bold text-sm">
                  ...
                  <div className="flex justify-between text-xl font-semibold pt-4 border-t border-slate-100">
                    <span>Total</span>
                ...
                {error && (
                  <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-2xl flex items-start gap-3 text-red-600 text-xs font-bold animate-in shake duration-500">
                ...
                <button
                  ...
                  className={cn(
                    "w-full py-6 rounded-2xl font-semibold text-xl flex items-center justify-center gap-3 transition-all relative overflow-hidden group/btn",
