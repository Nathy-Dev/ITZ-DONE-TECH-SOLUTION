  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full -z-10 pointer-events-none">
        ...
        <div className="absolute top-1/4 right-1/4 w-[1px] h-[400px] bg-gradient-to-b from-transparent via-indigo-500/10 to-transparent" />
      </div>

      <div className="max-w-7xl mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-16 items-center">
        {/* Left Content */}
        <div className="space-y-8 max-w-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-100 dark:border-indigo-900 rounded-full text-indigo-600 dark:text-indigo-400 text-sm font-medium">
            <span className="flex h-2 w-2 rounded-full bg-indigo-600 animate-pulse" />
            New: Master Next.js 15 & AI Engineering
          </div>
          
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-[1.1]">
            Unlock Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-cyan-500">Tech Potential</span> with ITZ-DONE.
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <Link 
              href="/courses" 
              className="w-full sm:w-auto px-8 py-4 bg-indigo-600 text-white font-semibold rounded-2xl hover:bg-indigo-700 shadow-lg shadow-indigo-500/25 transition-all flex items-center justify-center gap-2 group"
            >
              Explore Courses
            ...
            <Link 
              href="/register" 
              className="w-full sm:w-auto px-8 py-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 font-semibold rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-all flex items-center justify-center gap-2"
            >
              Start Learning Free
            </Link>
          </div>
        ...
        <div className="relative group">
          <div className="absolute inset-0 bg-indigo-600/5 blur-[40px] rounded-[40px] group-hover:bg-indigo-600/10 transition-colors" />
          <div className="relative aspect-video rounded-3xl border border-slate-200/50 dark:border-slate-800/50 overflow-hidden shadow-2xl bg-slate-900 group-hover:-translate-y-2 transition-transform duration-500">
             ...
             <div className="absolute inset-0 bg-gradient-to-br from-indigo-900 to-slate-950" />
