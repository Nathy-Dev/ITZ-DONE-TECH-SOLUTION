  ...
  return (
    <div className="space-y-8">
      ...
      <form onSubmit={handleSubmit} className="relative group">
        {replyTo && (
          <div className="absolute -top-10 left-0 right-0 flex items-center justify-between px-4 py-2 bg-blue-50 border border-blue-200 rounded-t-xl animate-in slide-in-from-bottom-2">
        ...
        <textarea
          ...
          className={cn(
            "w-full px-4 sm:px-6 py-3 bg-slate-50  border border-slate-200  focus:outline-none focus:ring-2 focus:ring-blue-600/20 resize-none font-medium min-h-[120px] transition-all",
        ...
        <div className="absolute bottom-4 right-4">
          <button
            ...
            className="flex items-center gap-2 px-4 sm:px-6 py-2.5 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition-all disabled:opacity-50 disabled:pointer-events-none shadow-sm shadow-blue-600/20"
          >
...
function MessageItem({ message, replies, onReply, onDelete }: any) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Replies */}
      {replies.length > 0 && (
        <div className="pl-14 space-y-4 border-l-2 border-slate-100 ml-5">
          <button 
            onClick={() => setShowReplies(!showReplies)}
            className="text-[10px] font-semibold uppercase tracking-widest text-blue-600 flex items-center gap-2 hover:underline mb-2"
          >
              ...
              <div className="flex-1 space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    ...
                    className="opacity-0 group-hover:opacity-100 p-1 hover:bg-red-50 rounded-lg text-red-500 transition-colors"
                  >
